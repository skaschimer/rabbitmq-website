...
<table className="release-series">
  ...
  <tr>
    <td><a href="https://github.com/rabbitmq/rabbitmq-amqp-java-client" target="_blank" rel="noopener noreferrer">AMQP 1.0 Java Client</a> 1.x</td>
    <td>Currently supported</td>
    <td></td>
    <td>11, 17, 21, 25, 26, 27 (EA)</td>
  </tr>
